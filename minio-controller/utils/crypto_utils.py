...
def derive_session_keys_static(
    ...
    if isinstance(server_priv_bytes, x25519.X25519PrivateKey):
        ...
        sb = server_priv_bytes.encode() if isinstance(server_priv_bytes, str) else server_priv_bytes
            ...
            # PEM encoded private key
                ...
                try:
                    ...
                    if len(dec) == 32:
                        ...
                        raise ValueError("server_priv_bytes is not a valid X25519 private key")
                except Exception as e:
                    raise ValueError("server_priv_bytes is not a valid X25519 private key") from e
        else:
            raise ValueError("server_priv_bytes must be bytes, str, or X25519PrivateKey")
